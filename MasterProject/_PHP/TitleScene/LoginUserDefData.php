<?php
	...
	// 유저 아이템 데이터 받아오는 부분
	$sqlList = mysqli_query($con, "Select u.ItemNo, u.ItemName, u.Level, u.isBuy, u.KindOfItem, u.isAttack, i.UnitAttack, i.UnitDefence, i.UnitHP, i.UnitAttSpeed, i.UnitPrice,i.UnitUpPrice,i.UnitRange from UserItem AS u JOIN DefItem AS i on u.KindOfItem = i.No and u.isAttack = 0 and u.UserId = '".$u_No."'");
