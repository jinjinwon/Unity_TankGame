...
public class AttUnit
{
    ...
    public AttUnitkind m_unitkind = AttUnitkind.Unit_0;     // 유닛 종류 <- DB에서 string 형식으로 저장됨    
    ...
    public float m_Att = 0;                                   // 유닛 공격력
    public float m_Def = 0;                                   // 유닛 방어력
    ...
    public float m_SkillTime = 0;                           // 유저 스킬 쿨타임
